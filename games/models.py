...
class Rating(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE) # the primary key of the user who assigns the grade
    game = models.ForeignKey(Game, on_delete=models.CASCADE) # the primary key of the game being evaluated
